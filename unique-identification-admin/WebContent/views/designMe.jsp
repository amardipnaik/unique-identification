...
<div class="container design_api_container">
	<div class='design_api'>
		...
		<div id='options'>
			<div class="T_type">
				<div id="radio1" ><img src="${pageContext.request.contextPath}/images/menu_icons/submenu/tee.jpg" width="100%" height="100%" />
				</div>
				<!--<div id="radio2" ><img src="tdesignAPI/images/menu_icons/submenu/collar.jpg" width="100%" height="100%" />
				</div>-->
				<div id="radio3" ><img src="${pageContext.request.contextPath}/images/menu_icons/submenu/hoodie.jpg" width="100%" height="100%" />
				</div>
			</div>
...
<?php
 ...
 ?> -->
		...
		<div id='view_mode'>
			<div  class="mode"><img id="o_front" src="${pageContext.request.contextPath}/images/product/tee/black/black_front.png" width="100%" height="80%" />FRONT
			</div>
			<div  class="mode"><img id="o_back" src="${pageContext.request.contextPath}/images/product/tee/black/black_back.png" width="100%" height="80%" />BACK
			</div>
			<div class="mode">
