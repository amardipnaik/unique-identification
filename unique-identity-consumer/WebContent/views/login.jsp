...
<body class="dashboardBody" ng-controller="mainController" background="images/background-wallpaper-web-images-sky-wallpaperweb-wallpapers.jpg" >
 ...
 <div class="row" style="min-height:1000px;">
    <div  class="col-sm-12">
        <h1 style="text-align:center">Unique ID System Online</h1>
        <hr/>
	...
	%>
             <% if(profile.equals("admin")) { %>
               ...
               My Profile
                ...
                <button ng-click="route('/myWallet.htm')" class="fiveup">
                My Wallet
                </button>
                
                    <br><br>
                   <button ng-click="route('/addWallet.htm')" class="fiveup">
               Add Wallet Money
                </button>
                ...
                <button ng-click="route('/ebill.htm')" class="fiveup">
                E-Bill Payment
                </button>
                
                
                <br><br>
                   <button ng-click="route('/gasBill.htm')" class="fiveup">
               Gas Bill Payment
                </button>
                
                  <br><br>
                   <button ng-click="route('/payment.htm')" class="fiveup">
               Payment Transfer
                </button>
